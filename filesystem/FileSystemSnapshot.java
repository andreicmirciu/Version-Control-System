...
public final class FileSystemSnapshot {
     ...
     *            the output writer
     */
    public FileSystemSnapshot(final Directory root, final OutputWriter outputWriter) {
        this.root = root;
        currentDir = root;
    ...
    public FileSystemSnapshot cloneFileSystem() {
        FileSystemSnapshot newFileSystem = new FileSystemSnapshot((Directory) this.root.clone(null),
                this.outputWriter);
     ...
     *            the dir to be set
     */
    public void setCurrentDir(final Directory newDir) {
     ...
     * @param path
     *            the path where to add the entity
     * @param name
     *            the name of the entity
     * @return the return code
     */
    public int addEntity(final EntityType type, final String path, final String name) {
        FileSystemEntity e;
