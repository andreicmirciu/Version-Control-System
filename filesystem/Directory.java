...
public final class Directory extends FileSystemEntity {
     ...
     *            the child entity
     */
    public void addEntity(final FileSystemEntity entity) {
    ...
    /**
     * Checks recursively if the path given leads to any entity inside of this
     * directory.
     *
     * @param path
     *            path to follow
     ...
     *
     * @param parts
     *            next entity and the rest of the path
     ...
     *
     * @param newParent
     *            the clone of the parent directory
