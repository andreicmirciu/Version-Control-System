...
public final class OperationParser {
     ...
     */
    public AbstractOperation parseOperation(final String newOperation) {
        ArrayList<String> operationArgs = new ArrayList<>(
                Arrays.asList(newOperation.split("\\s+")));
    ...
    private AbstractOperation parseVcsOperation(final String newOperation,
        ...
        default:
            return operationFactory.createOperation(OperationType.VCS_INVALID_OPERATION,
                    operationArgs);
        }
    }
    ...
    private AbstractOperation parseFileSystemOperation(final String newOperation,
        ...
        default:
            return operationFactory.createOperation(OperationType.FILESYSTEM_INVALID_OPERATION,
                    operationArgs);
        }
    }
