...
public final class ErrorCodeManager {
    ...
    private static final String VCS_STAGED_OP_STR = "Vcs: There are staged operations, "
            + "please do commit/rollback!";
     ...
     * @return
     */
    public boolean checkExitCode(final OutputWriter writer, final int exitCode) {
        String err = "";
