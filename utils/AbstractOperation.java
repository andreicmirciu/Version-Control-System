...
/**
 * Every operation must extend this class. This is a template for a filesystem
 * operation or a vcs operation.
 *
 */
public abstract class AbstractOperation {
     ...
     */
    public AbstractOperation(final OperationType type, final ArrayList<String> operationArgs) {
        this.type = type;
